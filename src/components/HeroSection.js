        ...
        <div className="container">
            <div className="grid grid-two-column">
                <div className="hero-section-data">
                    ...
                    <h1>{props.name}</h1>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique excepturi molestias eum fugiat quaerat voluptas nobis, aliquam dolorem alias mollitia rem, ex provident. Facere, exercitationem molestias consectetur autem aliquam voluptate.</p>
